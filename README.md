...
- When we given a task we :
    ...
    - If the code matches the functional, techniqual requirement, follows our design and ready to merge, i merge it the the main branch, if not i leave comments
